...
import { Box, IconButton, InputBase, Typography, Select, MenuItem, FormContorl, useTheme, useMediaQuery } from "@mui/material" 
...
const NavBar = () => {
  const [mobileToggled, setMobileMenu] = useState(false);
  ...
  return (
    ...
    <FlexBetween gap = "1.75rem">
      ...
      {isNonMobileScreens ? (<FlexBetween gap = "2rem">
       ...
       (
       <IconButton onClick={() => setMobileMenu(!mobileToggled)}>
        <Menu/>
      </IconButton>)}
      ...
      {!isNonMobileScreens && mobileToggled && ( 
        <Box 
        position="fixed"
        right="0"
        height="100%"
